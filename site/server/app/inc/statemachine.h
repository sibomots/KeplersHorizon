...
///////////////////////////////////////////
#ifndef __KH_STATEMACHINE_H__
#define __KH_STATEMACHINE_H__
...
class StateMachine
{
  ...
  public:
    ...
    // BUGBUG -  legacy block, ingested. needs to be cleaned up
    ...
    std::string get_player_name(int game_id, const char& seat);
