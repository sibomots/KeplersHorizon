...
///////////////////////////////////////////
#ifndef __KH_HEX_EVENTS_H__
#define __KH_HEX_EVENTS_H__
...
class HexEventEngine
{
  public:
    ...
    static int get_movement_modifier(int game_id, int round,
                                     const std::string& hex);
    static int get_combat_modifier(int game_id, int round,
                                   const std::string& hex);
    static float get_salvage_multiplier(int game_id, int round,
                                        const std::string& hex);
    static int get_extraction_modifier(int game_id, int round,
                                       const std::string& hex);
