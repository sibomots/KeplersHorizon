                                                   ...
                                                   const std::string& hex_id)
{
    ...
    std::string q =
        "SELECT name FROM star_systems WHERE module_id=? AND hex_id=?";
...
int StarSystemConstraints::getConstraintModifier(
    int game_id, const std::string& hex_id, const std::string& constraint_type)
{
