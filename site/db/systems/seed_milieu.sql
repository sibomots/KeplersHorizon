...
LOAD DATA LOCAL INFILE 'data/anomalies.csv'
INTO TABLE system_anomalies
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
(id,system_name,anomaly_type,name,effect,discovery_text);

LOAD DATA LOCAL INFILE 'data/asteroid_belts.csv'
...
LOAD DATA LOCAL INFILE 'data/grimoire_rumors.csv'
...
LOAD DATA LOCAL INFILE 'data/moons.csv'
...
LOAD DATA LOCAL INFILE 'data/planets.csv'
...
LOAD DATA LOCAL INFILE 'data/populations.csv'
...
LOAD DATA LOCAL INFILE 'data/resources.csv'
...
LOAD DATA LOCAL INFILE 'data/species.csv'
...
LOAD DATA LOCAL INFILE 'data/stars.csv'
